...
1. Create `for_loop.sh` that:
   ...
   ![for_loop](images/for-loop-output.png)
...
1. Create `countdown.sh` that:
   ...
   ![countdown](images/countdown-output.png)
...
2. Create `args_demo.sh` that:
   ...
   ![args_demo](images/args-demo-output.png)
...
1. Create `install_packages.sh` that:
   ...
   ![packages](images/install-packages-output.png)
...
1. Create `safe_script.sh` that:
   ...
   ![safe](images/safe-script-output.png)


2. Modify your `install_packages.sh` to check if the script is being run as root — exit with a message if not.

   [Script](scripts/install_packages_m.sh)
   
   ![snapshot](images/install-packages-output_m.png)
