...
1. Create `functions.sh` with:
   ...
   ![task1](images/functions-output.png)
...
1. Create `disk_check.sh` with:
   ...
   ![task2](images/disk-check-output.png)
...
- `set -o pipefail` → Pipeline fails if any command fails.
   ...
   ![task3](images/strict-mode-output.png)
...
1. Create `local_demo.sh` with:
   ...
   ![task4](images/local-variables-output.png)
...
7. Use `set -euo pipefail` at the top
   ...
   ![task5](images/system-info-output.png)
