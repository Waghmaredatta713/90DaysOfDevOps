...
**Users/Application**  -  These are people or systems interacting with Linux. ( Example-  You typing commands)
  |
  |
...
**Kernel**		   -	Heart of Linux (Brain) Only kernel knows how to talk to hardware
  |
  |
**Hardware**	    -	This is physical devices (Example - CPU, RAM, Disk, ) 
